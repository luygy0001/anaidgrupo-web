...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center py-16 lg:py-24 overflow-hidden bg-slate-950">
      {/* ============================================================
          FONDO CINEMÁTICO: Chalet moderno con piscina al anochecer
          ============================================================ */}
      <div className="absolute inset-0 z-0">
        ...
        {/* Máscara de gradiente suave: sombra a la izquierda para contraste del texto, limpia a la derecha para ver el chalet y la piscina */}
      ...
      <Container className="relative z-10 w-full">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 text-xs font-bold uppercase tracking-wider shadow-sm backdrop-blur-sm">
              <Zap className="w-3.5 h-3.5 text-amber-400" />
              Presupuestos con IA en menos de 60 minutos
            </div>

            {/* H1 de Alto Impacto */}
            <h1 className="text-3xl sm:text-5xl lg:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-lg">
            ...
            {/* Subtítulo puente */}
            <p className="text-base sm:text-lg text-slate-100 leading-relaxed max-w-2xl drop-shadow-md font-medium">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs font-semibold text-white bg-slate-900/70 backdrop-blur-md p-2.5 rounded-xl border border-white/10 shadow-sm">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-white bg-slate-900/70 backdrop-blur-md p-2.5 rounded-xl border border-white/10 shadow-sm col-span-2 sm:col-span-1">
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <a
                href="#contacto"
                className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-black text-sm uppercase tracking-wider shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all transform hover:-translate-y-0.5 text-center"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 px-7 py-4 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-black text-sm tracking-wide shadow-lg shadow-[#25D366]/30 transition-all transform hover:-translate-y-0.5 text-center"
              >
            ...
            <div className="pt-2 flex items-center gap-2 text-xs text-slate-200 font-medium flex-wrap">
              ...
              <a
                href={`tel:${PHONE}`}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900/80 hover:bg-slate-900 border border-white/15 text-amber-300 hover:text-amber-200 font-bold transition-all shadow-xs backdrop-blur-sm"
                aria-label={`Llamar al teléfono ${PHONE_DISPLAY}`}
              >
                <Phone className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span>Llamar al {PHONE_DISPLAY}</span>
              </a>
              <span className="text-slate-300">(Sin compromiso)</span>
            </div>
          </div>

          {/* Columna Visual de Muestra en directo (5 cols) - Tarjeta de Cristal Translúcido */}
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-slate-950/70 backdrop-blur-md p-3 sm:p-4 space-y-3">
              ...
              <div className="relative h-60 sm:h-64 w-full rounded-xl overflow-hidden border border-white/10">
                <Image
                  src={active.image}
                  alt={active.title}
                  fill
                ...
                <div className="absolute bottom-3 left-3 bg-slate-950/85 backdrop-blur-md text-amber-300 text-[11px] font-bold px-2.5 py-1 rounded-md border border-white/10">
                  {active.location}
                </div>
              </div>
